...
mod tests {
    ...
    fn get_ark_verifying_key() -> ark_groth16::VerifyingKey<Bn254> {
        ...
        let delta_g2 = G2Affine::new(
            Fq2::new(
                Fq::from_str(
                    "9589167770510786582236660722855640917078695471000880439848586656649531970279",
                )
                .unwrap(),
                Fq::from_str(
                    "9238442162964221501121518341254641126504952481461495379508281563165579644274",
                )
                .unwrap(),
            ),
            Fq2::new(
                Fq::from_str(
                    "17367297383792678572217852143778900447438319399838366952174061971615187212747",
                )
                .unwrap(),
                Fq::from_str(
                    "14583658278705005375734086789133240261633678409170830120618117993660506327574",
                )
                .unwrap(),
            ),
        );
        ...
        let gamma_abc_g1 = vec![
            G1Affine::new(
                Fq::from_str(
                    "14691926124455728291157990391111273293252157759090668988874591394529024875470",
                )
                .unwrap(),
                Fq::from_str(
                    "6500045822392499035809034861045704312575488637874860969435371227192538734492",
                )
                .unwrap(),
            ),
            G1Affine::new(
                Fq::from_str(
                    "5696019686831953479995148080877549592025257705264800698442781400942117921381",
                )
                .unwrap(),
                Fq::from_str(
                    "10113109945288267815127323740003040580895156912359043889883632397597411001997",
                )
                .unwrap(),
            ),
            G1Affine::new(
                Fq::from_str(
                    "16522476655041975687233644548466649484265867453183931396292242802127439982096",
                )
                .unwrap(),
                Fq::from_str(
                    "12442707102671220891558082925884673281705627099897909774806596156831663014838",
                )
                .unwrap(),
            ),
            G1Affine::new(
                Fq::from_str(
                    "6196787282706976687517584152344968838647071806734581938207923856529737376170",
                )
                .unwrap(),
                Fq::from_str(
                    "8069038683402199721906587428833639904242728188244594323145352707665719979193",
                )
                .unwrap(),
            ),
            G1Affine::new(
                Fq::from_str(
                    "6623758673375911398053815616352328311628676174565727649162654342919022268888",
                )
                .unwrap(),
                Fq::from_str(
                    "2463022798565201581111416089752592204164225451245958811765103333348486139869",
                )
                .unwrap(),
            ),
            G1Affine::new(
                Fq::from_str(
                    "3574552915126587856934655960496967410597727764920485828880057853909223809324",
                )
                .unwrap(),
                Fq::from_str(
                    "10518081151167773306128659127457947766507354564998609871391740605080059116172",
                )
                .unwrap(),
            ),
        ];
