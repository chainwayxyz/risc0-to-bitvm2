...
FROM rust:1.82.0 AS dependencies
...
COPY groth16/pot23.ptau /ceremony/groth16_proof/groth16/pot19.ptau
...
ENTRYPOINT ["/ceremony/run_ceremony.sh", "/ceremony/groth16_proof/circuits/verify_for_guest.r1cs", "/ceremony/groth16_proof/groth16/pot19.ptau"]